...
public class CustomerServiceImpl implements ICustomerService {
    ...
    @Override
    public Optional<Customer> findByPhoneAndIdIsNot(String phone, Long id) {
        return customerRepository.findByPhoneAndIdIsNot(phone, id);
    }
    ...
    @Override
    public Optional<CustomerDTO> getByPhoneDTO(String phone) {
